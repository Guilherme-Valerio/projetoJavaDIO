...
public class EstoqueProdutos {
    ...
    public Produto obterProdutoMaiorQuantidadeValorTotalNoEstoque(){
        ...
        double produtoMaiorValorMomentaneo = 0;
        double produtoMaiorValor = Double.MIN_VALUE;
        if(!estoqueProdutoMap.isEmpty()){
            for(Produto p : estoqueProdutoMap.values()){
                produtoMaiorValorMomentaneo = p.getPreco()*p.getQuantidade();
                if(produtoMaiorValorMomentaneo > produtoMaiorValor){
                    produtoMaiorQuantidade = p;
                    produtoMaiorValor = produtoMaiorValorMomentaneo;
                }
            }
         }
